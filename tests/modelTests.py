...
class TestMethods(unittest.TestCase):
    ...
    def test_baseOOP_Model_Exists(self):
        Py2UML.run(self.IN_PATH, self.OUT_PATH, self.DIAGRAM_NAME, self.FILE_TYPE)
    ...
    def test_baseOOP_Model_removes_dot(self):
        Py2UML.run(self.IN_PATH, self.OUT_PATH, self.DIAGRAM_NAME, self.FILE_TYPE, remove_dots=True)
    ...
    def test_clean_source(self):
        ...
        Py2UML.run(project_path, self.OUT_PATH, self.DIAGRAM_NAME, self.FILE_TYPE, remove_dots=True, clean_source=True)
    ...
    def test_single_file(self):
        Py2UML.run(self.IN_PATH + "/chessGame.py", self.OUT_PATH, self.DIAGRAM_NAME, self.FILE_TYPE, remove_dots=True,
                   clean_source=True)
