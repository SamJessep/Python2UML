...
class TestMethods(unittest.TestCase):
    ...
    def test_BaseOOP_Model_Black_List(self):
        p2u = Py2UML(in_path=self.IN_PATH, out_path=self.OUT_PATH, diagram_name=self.DIAGRAM_NAME+"bl",black_list=["chessPiece.py", "__init__.py"], clean_up_dot=True)
    ...
    def test_clean_source(self):
        ...
        p2u = Py2UML(in_path=project_path, out_path=self.OUT_PATH, diagram_name=self.DIAGRAM_NAME, clean_up_dot=True, clean_source_code=True)
        self.makeDiagram(p2u)
    ...
    def test_single_file(self):
        p2u = Py2UML(in_path=self.IN_PATH+"/chessGame.py", out_path=self.OUT_PATH, diagram_name=self.DIAGRAM_NAME, clean_up_dot=True)
        self.makeDiagram(p2u)
