            ...
            <head>
                ...
                <script>
                    <xsl:text disable-output-escaping="yes">
                        ...
                        if (lastSelected)
                        {
                        removeClass (document.getElementById ("index_" + lastSelected.replace (':', '_')),
                        "index_selected");
                        removeClass (document.getElementById ("content_" + lastSelected.replace (':', '_')),
                        "content_selected");
                        }
                        ...
                        addClass (document.getElementById ("content_" + lastSelected.replace (':', '_')),
                        "content_selected");
                        }
                        return true;
                        ...
                        // NOTE: this is not strictly necessary since hashed () will catch it but it helps with the
                        responsiveness
                    ...
                    <xsl:for-each select="/xsd:schema/xsd:attribute">
                        <div id="content_d_{@name}" class="content">
                            ...
                            <div class="text">
                                ...
                                <xsl:for-each
                                        select="$arguments/xsd:schema/xsd:simpleType[@name='layout']/xsd:restriction/xsd:enumeration">
                                    <span class="layout">
                                        <xsl:attribute name="class">layout
                                            <xsl:if test="$attributeLayouts and not(contains(concat(' ',$attributeLayouts,' '),concat(' ',@value,' ')))">
                                                missing
                                            </xsl:if>
                                        </xsl:attribute>
                            ...
                            <div class="text">
                                ...
                                <xsl:for-each select="/xsd:schema/xsd:complexType">
                                    <span class="comp">
                                        <xsl:attribute name="class">comp
                                            <xsl:if test="not(xsd:attribute[@ref=$attributeName])">missing</xsl:if>
                                        </xsl:attribute>
                                        <xsl:value-of select="@name"/>
                                    </span>
                                    <xsl:text></xsl:text>
                            ...
                            <div class="text">
                                <xsl:choose>
                                    <xsl:when test="@gv:formats">
                                        <span class="format">
                                            <xsl:value-of select="@gv:formats"/>
                                        </span>
                                    </xsl:when>
                                    <xsl:otherwise>
